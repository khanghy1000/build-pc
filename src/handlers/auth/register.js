            ...
            <form id="formDangKy" style="background-color: #193541; padding: 50px; border-radius: 5px;">
                ...
                <div style="display: flex; align-items: center; position: relative; margin-bottom: 20px;">
                    ...
                    <input name="username" type="text"
                        style="width: 100%; padding-left: 2.5rem; height: 1.5rem; border-radius: 5px;"
                ...
                <div style="
                    ...
                    margin-bottom: 20px;
                    ">
                    <i class="icon-mail-alt" style="position: absolute; left: 0.5rem"></i>
                ...
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <h6 style="width: 60%; color: aliceblue; font-weight: 400; margin: 0">Bằng cách nhấn nút Gửi, bạn đã
                        đồng
        ...
        thisForm.forEach((el) => {
            ...
            el.addEventListener('submit', async function (e) {
                ...
                if (result == 200) {
                    ...
                    popup("Username và Password không ngắn hơn 8 ký tự", "rgb(171 84 84)")
                }else if (result == 501) {
                    popup("Tài khoản đã tồn tại", "rgb(171 84 84)")
                }
