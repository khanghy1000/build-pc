...
<div id="nav" style="height: 100px; display: flex; background-color: rgb(26, 53, 66); justify-content: space-between; position: relative; z-index: 2">
    ...
    <div style="margin: auto;position: absolute;left: 0;right: 0;width: fit-content;height: fit-content;top: 0;bottom: 0; display: flex; align-items: center; justify-content: center; flex-direction: column;">
        <h1 style=" color: aliceblue; text-shadow: -1px -1px 0 #2196f3, 1px -1px 0 #2196f3, -1px 1px 0 #2196f3, 2px 2px 0 #2196f3;">Start your build NOW!</h1>
        <a href="/create_build" style=" padding: 20px; font-size: x-large; background-color: rgb(0 98 146); border-radius: 5px">START YOUR BUILD!</a>
    </div>
</body>
